...
public class GreatingAspect {
    ...
    @Before("GreatingServicePointCuts.greatingLoggerPointCut()")
    ...
    @After("GreatingServicePointCuts.greatingLoggerPointCut()")
    ...
    @AfterReturning("GreatingServicePointCuts.greatingLoggerPointCut()")
    ...
    @AfterThrowing("GreatingServicePointCuts.greatingLoggerPointCut()")
    ...
    @Around("GreatingServicePointCuts.greatingLoggerPointCut()")
